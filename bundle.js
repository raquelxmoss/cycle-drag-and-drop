...
exports.default = mousePositionDriver;
...
function fromEvent(element, eventName) {
  var event$ = _xstream2.default.create();
  element.addEventListener(eventName, function (ev) {
    return event$.shamefullySendNext(ev);
  });
  return event$;
}

function mousePositionDriver() {
  return {
...
},{"xstream":69}],2:[function(require,module,exports){
'use strict';
...
},{"xstream":69}],3:[function(require,module,exports){
'use strict';
...
var _mousePositionDriver = require('./drivers/mouse-position-driver');

var _mousePositionDriver2 = _interopRequireDefault(_mousePositionDriver);

var _preventDefaultDriver = require('./drivers/prevent-default-driver');
...
var drivers = {
  ...
  Mouse: _mousePositionDriver2.default,
  PreventDefault: _preventDefaultDriver2.default
};

(0, _xstreamRun.run)(_app2.default, drivers);

},{"./drivers/mouse-position-driver":1,"./drivers/prevent-default-driver":2,"./src/app":70,"@cycle/dom":13,"@cycle/xstream-run":24}],4:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":8,"./utils":21,"matches-selector":46}],6:[function(require,module,exports){
"use strict";
...
},{"./BubblingSimulator":5,"./ElementFinder":7,"./fromEvent":10,"./isolate":14,"@cycle/xstream-adapter":22}],7:[function(require,module,exports){
"use strict";
var ScopeChecker_1 = require('./ScopeChecker');
var utils_1 = require('./utils');
var matchesSelector;
...
},{"./ScopeChecker":8,"./utils":21,"matches-selector":46}],8:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":12,"snabbdom-selector/lib/classNameFromVNode":47,"snabbdom-selector/lib/selectorParser":48}],10:[function(require,module,exports){
"use strict";
...
},{"xstream":69}],11:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"snabbdom/is":58,"snabbdom/vnode":67}],13:[function(require,module,exports){
...
},{"./hyperscript":12,"./hyperscript-helpers":11,"./makeDOMDriver":16,"./makeHTMLDriver":17,"./mockDOMSource":18,"snabbdom/thunk":66}],14:[function(require,module,exports){
"use strict";
var utils_1 = require('./utils');
...
},{"./DOMSource":6,"./VNodeWrapper":9,"./isolateModule":15,"./modules":19,"./transposition":20,"./utils":21,"@cycle/xstream-adapter":22,"snabbdom":65}],17:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
var transposition_1 = require('./transposition');
...
},{"./transposition":20,"@cycle/xstream-adapter":22,"snabbdom-to-html":50,"xstream":69}],18:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"xstream":69}],19:[function(require,module,exports){
"use strict";
...
},{"snabbdom/modules/attributes":59,"snabbdom/modules/class":60,"snabbdom/modules/eventlisteners":61,"snabbdom/modules/hero":62,"snabbdom/modules/props":63,"snabbdom/modules/style":64}],20:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":22,"xstream":69}],21:[function(require,module,exports){
"use strict";
...
},{"xstream":69}],23:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var XStreamAdapter = {
    adapt: function (originStream, originStreamSubscribe) {
...
},{"xstream":69}],24:[function(require,module,exports){
"use strict";
...
},{"@cycle/base":4,"@cycle/xstream-adapter":23}],25:[function(require,module,exports){
/*!
...
},{"lodash.isarguments":38,"lodash.isarray":39}],27:[function(require,module,exports){
/**
...
},{"lodash._baseindexof":28,"lodash._cacheindexof":31,"lodash._createcache":32}],30:[function(require,module,exports){
/**
...
},{"lodash._getnative":33}],33:[function(require,module,exports){
/**
...
},{"lodash._root":34}],36:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":34}],37:[function(require,module,exports){
/**
 * lodash 3.0.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._basefor":27,"lodash._bindcallback":30,"lodash.keys":41}],38:[function(require,module,exports){
/**
...
},{"lodash.deburr":35,"lodash.words":44}],41:[function(require,module,exports){
/**
 * lodash 3.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":33,"lodash.isarguments":38,"lodash.isarray":39}],42:[function(require,module,exports){
/**
...
},{"lodash._baseflatten":26,"lodash._baseuniq":29,"lodash.restparam":42}],44:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":34}],45:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./selectorParser":48}],48:[function(require,module,exports){
'use strict';
...
},{"browser-split":25}],49:[function(require,module,exports){
...
},{"./init":51,"./modules/attributes":52,"./modules/style":53}],51:[function(require,module,exports){
...
},{"./container-elements":49,"./parse-selector":54,"./void-elements":55}],52:[function(require,module,exports){
...
},{"../parse-selector":54,"lodash.escape":36,"lodash.forown":37,"lodash.union":43}],53:[function(require,module,exports){
...
},{"lodash.escape":36,"lodash.forown":37,"lodash.kebabcase":40}],54:[function(require,module,exports){
...
},{"browser-split":25}],55:[function(require,module,exports){
...
function Board() {
  return _lodash2.default.range(0, 8).map(function () {
    return _lodash2.default.range(0, 8).map(function (square) {
      return Square();
    });
  });
}
...
function legalMove(knightPosition, squareCoordinates) {
  if (_lodash2.default.isEqual(knightPosition, squareCoordinates)) {
    return false;
  }

  var moves = [{ x: -2, y: -1 }, { x: -2, y: 1 }, { x: 2, y: -1 }, { x: 2, y: 1 }, { x: -1, y: -2 }, { x: -1, y: 2 }, { x: 1, y: -2 }, { x: 1, y: 2 }];

  var potentialMoves = moves.map(function (move) {
    return {
  ...
  var isLegal = potentialMoves.some(function (potentialMove) {
    return _lodash2.default.isEqual(potentialMove, squareCoordinates);
  });
...
function renderRow(row, rowIndex, state) {
  return (0, _dom.div)('.row', row.map(function (square, index) {
    return renderSquare(square, rowIndex, index, state);
  }));
}

function highlightLegalSquare(state, rowIndex, squareIndex) {
  var currentSquare = { x: rowIndex, y: squareIndex };

  if (!_lodash2.default.isEqual(state.mouseIsOver, currentSquare)) {
    return;
  }
...
function renderSquare(square, rowIndex, squareIndex, state) {
  var knight = hasKnight(state.knightPosition, rowIndex, squareIndex);
  var highlight = highlightLegalSquare(state, rowIndex, squareIndex);

  return (0, _dom.div)('.square ' + (knight ? 'knight' : '') + ' ' + (highlight ? 'legal-move' : ''), {
    attrs: {
      'data-row': rowIndex,
...
function renderDraggingKnight(isDragging, mousePosition) {
  ...
  return (0, _dom.div)('.square .draggingKnight', { style: style });
}

function view(state) {
  return (0, _dom.div)('.container', [renderDraggingKnight(state.knightIsDragging, state.mousePosition), (0, _dom.div)('.board', state.board.map(function (row, index) {
    return renderRow(row, index, state);
  }))]);
};

function dragKnight() {
  return function (state) {
    return Object.assign({}, state, { knightIsDragging: true });
  };
}

function dropKnight(knightPosition) {
  return function (state) {
    var canMove = legalMove(state.knightPosition, knightPosition);

    if (!state.knightIsDragging || !canMove) {
      return Object.assign({}, state, { knightIsDragging: false, knightPosition: state.knightPosition });
    }

    return Object.assign({}, state, { knightIsDragging: false, knightPosition: knightPosition });
  };
}

function highlightLegalSquares(squarePosition) {
  return function (state) {
    var isLegal = legalMove(state.knightPosition, squarePosition);
...
function main(_ref) {
  ...
  var knightMouseDown$ = DOM.select('.knight').events('mousedown');

  var squareMouseUp$ = DOM.select('.square').events('mouseup');

  var squareMouseOver$ = DOM.select('.square').events('mouseover');

  var dragKnight$ = knightMouseDown$.map(dragKnight);

  var dropKnight$ = squareMouseUp$.map(function (ev) {
    var x = parseInt(ev.target.getAttribute('data-row'));
    var y = parseInt(ev.target.getAttribute('data-col'));

    return { x: x, y: y };
  }).map(dropKnight);

  var mouseIsOver$ = squareMouseOver$.map(function (ev) {
    var x = parseInt(ev.target.getAttribute('data-row'));
    var y = parseInt(ev.target.getAttribute('data-col'));
    ...
    return function (state) {
      return Object.assign({}, state, { mouseIsOver: pos });
    };
  });

  var mousePosition$ = Mouse.positions().map(function (pos) {
    return function (state) {
      return Object.assign({}, state, { mousePosition: pos });
    };
  });

  var action$ = _xstream2.default.merge(mousePosition$, dragKnight$, dropKnight$, mouseIsOver$);
  ...
  var preventDefault$ = _xstream2.default.merge(squareMouseUp$, knightMouseDown$);
...
},{"@cycle/dom":13,"lodash":45,"xstream":69}]},{},[3]);
